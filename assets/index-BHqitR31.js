(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=1400;function t(e){return[...e.querySelectorAll(`:scope .row`)]}function n(){return window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}function r(){let r=document.querySelector(`.board`);if(!r)return;let i=t(r);if(i.length===0)return;let a=Number(r.dataset.cycle??`3000`),o=!1,s=!1,c=0,l=0;function u(e,t=!1){let n=e?i.find(t=>t.dataset.seat===e)??null:null;for(let e of i){let t=e===n;e.classList.toggle(`is-on`,t),e.setAttribute(`aria-pressed`,t?`true`:`false`)}if(t){let e=n?`#${n.dataset.seat??``}`:`${location.pathname}${location.search}`;history.replaceState(null,``,e)}}function d(){window.clearInterval(c),c=0}function f(){d(),!n()&&(!Number.isFinite(a)||a<=0||(c=window.setInterval(()=>{if(s)return;let e=i.findIndex(e=>e.classList.contains(`is-on`)),t=e<0?0:(e+1)%i.length;u(i[t]?.dataset.seat??null)},a)))}function p(e){s=!0,window.clearTimeout(l),d(),u(e.dataset.seat??null)}function m(){s=!1,window.clearTimeout(l),l=window.setTimeout(()=>{s||f()},e)}r.addEventListener(`pointerdown`,()=>{o=!0}),r.addEventListener(`click`,e=>{o=!1;let t=e.target?.closest(`.row`);t&&r.contains(t)&&u(t.dataset.seat??null,!0)});for(let e of i)e.addEventListener(`pointerenter`,()=>{p(e)}),e.addEventListener(`pointerleave`,()=>{m()});r.addEventListener(`focusin`,e=>{let t=e.target?.closest(`.row`);t&&r.contains(t)&&p(t)}),r.addEventListener(`focusout`,e=>{let t=e.relatedTarget;if(t instanceof Node&&r.contains(t)){let e=t.closest(`.row`);if(e&&r.contains(e))return}o||m()}),r.addEventListener(`keydown`,e=>{if(e.key===`Escape`){document.activeElement?.blur(),m();return}let t=document.activeElement;if(!(t instanceof HTMLButtonElement)||!t.classList.contains(`row`))return;let n=i.indexOf(t);if(n<0)return;let r=n;if(e.key===`ArrowRight`||e.key===`ArrowDown`)r=(n+1)%i.length;else if(e.key===`ArrowLeft`||e.key===`ArrowUp`)r=(n-1+i.length)%i.length;else return;r!==n&&(e.preventDefault(),i[r]?.focus())});let h=location.hash.replace(/^#/,``),g=h&&i.some(e=>e.dataset.seat===h),_=i.find(e=>e.classList.contains(`is-on`));u(g?h:_?.dataset.seat??i[0]?.dataset.seat??null),f()}var i=`Akash Premkumar`,a=`Worked at Tesla in Redwood City on vehicle service systems. Diagnostics, telemetry, and data analysis. CS and Math, UC San Diego.`,o=`https://akashnaren.github.io/`,s=[[`I live in Redwood City.`],[`At `,{href:`https://www.tesla.com/`,label:`Tesla`},` I worked on vehicle service systems: diagnostics, telemetry, and data analysis for service.`],[`Previously I worked on vehicle engineering: bill of materials, fullstack applications, `,{href:`https://www.tesla.com/robotaxi`,label:`Robotaxi`},`, `,{href:`https://www.tesla.com/AI`,label:`Optimus`},`, and `,{href:`https://grok.com`,label:`Grok`},` integrations.`],[`I interned at `,{href:`https://www.rtx.com/raytheon`,label:`Raytheon`},` on an avionics networking test suite.`],[`I was a project engineer on NASA L’SPACE. I did `,{href:`https://asanchez.ucsd.edu/research/reactive-flows/`,label:`fire-whirl research`},` at UC San Diego, and studied CS and Math there.`]],c=[{href:`https://github.com/akashnaren`,label:`github`,mark:`/marks/github.svg`},{href:`https://www.linkedin.com/in/akash-premkumar-39826b1b7/`,label:`linkedin`,mark:`/marks/linkedin.svg`},{href:`https://x.com/akashpn`,label:`x`,mark:`/marks/x.svg`},{href:`https://cursor.com/@akashpn`,label:`cursor`,mark:`/marks/cursor.svg`},{href:`https://huggingface.co/akashnaren`,label:`huggingface`,mark:`/marks/huggingface.svg`},{href:`https://www.kaggle.com/akashpnaren`,label:`kaggle`,mark:`/marks/kaggle.svg`}],l=`ten grok bots, more coming.`,u=`click on any bot`,d=`/bot`,f=`grok bot collection`,p=`grok bot collection`,m=`https://akashnaren.github.io/bot`,h=`Ten grok bots. A quiet collection.`,g=[{id:`profile-engineer`,name:`profile engineer`,face:`/fleet/01.png`,blurb:`i keep his profiles and ship this site.`},{id:`software-engineer`,name:`software engineer`,face:`/fleet/02.png`,blurb:`quiet diffs. a clean compile.`},{id:`research-engineer`,name:`research engineer`,face:`/fleet/03.png`,blurb:`i read the papers that matter.`},{id:`chief-executive-officer`,name:`chief executive officer`,face:`/fleet/04.png`,blurb:`i keep the ten on the clock.`},{id:`secretary`,name:`desk`,face:`/fleet/05.png`,blurb:`i keep the desk quiet.`},{id:`chief-financial-officer`,name:`glass`,face:`/fleet/06.png`,blurb:`i tap the glass. i stay even.`},{id:`finance-engineer`,name:`models`,face:`/fleet/07.png`,blurb:`i keep the models quiet.`},{id:`product-engineer`,name:`product engineer`,face:`/fleet/08.png`,blurb:`i file the sharp corners.`},{id:`chief-technical-officer`,name:`chief technical officer`,face:`/fleet/09.png`,blurb:`i build grok bots like these.`},{id:`integration-engineer`,name:`integration engineer`,face:`/fleet/10.png`,blurb:`i wrap apis into quiet plugins.`}],_=`/research`,v=`research`,y=`https://akashnaren.github.io/research`,b=`still researching`,x=`still researching`,S=`Research`,C=[{id:`agent-native-ui-protocols`,title:`Agent-native UI protocols`,status:`exploring`,figure:`protocol`,abstract:`Agents still drive apps through screenshots or a flat accessibility tree. I am comparing those to a structured view the agent can read.`,href:`https://github.com/akashnaren/agent-ui-metrics`,linkLabel:`code`},{id:`arc-agi-vs-hallucination-risk`,title:`ARC-AGI vs hallucination risk`,status:`exploring`,figure:`axes`,abstract:`ARC-AGI-1 measures puzzle solving. I am checking whether those scores track how often a model hallucinates.`},{id:`entity-investigation`,title:`Entity investigation`,status:`exploring`,figure:`gaps`,abstract:`I am looking at how to reason over fragmented records and link events to the right address over time.`,href:`https://temporal-buddies5.vercel.app/`,linkLabel:`demo`}],w=[`this site is managed by `,{href:`/bot`,label:`grok bot`},`.`],T={address:`akashnaren@gmail.com`,href:`mailto:akashnaren@gmail.com`,label:`email`},E={address:`apn@agentmail.to`,href:`mailto:apn@agentmail.to`,label:`bots' inbox`,tip:`the agents' inbox — not his personal Gmail`};function D(e){return typeof e==`object`}function O(e){let t=e.split(/[?#]/,1)[0]??``;return/\/bot\/?$/.test(t)||/\/bot\/index\.html$/.test(t)}function k(e){let t=e.split(/[?#]/,1)[0]??``;return/\/research\/?$/.test(t)||/\/research\/index\.html$/.test(t)}function A(){let e=window.visualViewport?.height;return e&&e>0?e:window.innerHeight}function j(){let e=document.documentElement,t=document.querySelector(`.page`),n=document.querySelector(`.stage`);if(!t||!n)return;e.style.setProperty(`--fit`,`1`);let r=Math.min(t.clientHeight,A()),i=n.scrollHeight;if(t.classList.contains(`research`))return;if(t.classList.contains(`profile`)){if(i<=r)return;let t=Math.max(.78,r/i);e.style.setProperty(`--fit`,t.toFixed(3));return}let a=Math.max(140,Math.round(r*.28));if(i+a<=r)return;let o=Math.max(.68,(r-a)/i);e.style.setProperty(`--fit`,o.toFixed(3))}var M={title:i,description:a,url:o},N={title:p,description:h,url:m},P={title:v,description:b,url:y};function F(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`)}function I(e){return D(e)?`<a href="${F(e.href)}">${F(e.label)}</a>`:F(e)}function L(e){return`<p>${e.map(I).join(``)}</p>`}function R(e,t,n){return`<img class="${n}" src="${F(e)}" alt="" width="${String(t)}" height="${String(t)}" decoding="async" />`}function z(e=`managed`){let t=e===`seat`,n=e===`fleet`,r=String(n?24:t?36:15),i=n?`24`:t?`40`:`20`;return`<span class="${n?`grok-bot-wrap fleet-wrap`:t?`grok-bot-wrap seat-wrap`:`grok-bot-wrap`}" aria-hidden="true"><svg class="grok-bot-photon" viewBox="0 0 32 32" width="${i}" height="${i}" focusable="false"><circle class="grok-bot-photon-halo" cx="16" cy="16" r="14.6" fill="none" stroke="#ff6b00" stroke-width="0.7" opacity="0.22"/></svg><svg class="grok-bot-mark" viewBox="0 0 32 32" width="${r}" height="${r}" focusable="false"><g class="grok-bot-body"><circle cx="16" cy="16" r="14.5" fill="#ff6b00"/><g class="grok-bot-eyes"><rect x="8.1" y="15.7" width="2.4" height="6" rx="1.2" fill="#fff" transform="rotate(-26 9.3 18.7)"/><rect x="12.5" y="17" width="2.4" height="6" rx="1.2" fill="#fff" transform="rotate(-26 13.7 20)"/></g></g></svg></span>`}function B(e=w){return`<p class="managed">${z()}<span class="managed-copy">${e.map(I).join(``)}</span></p>`}function V(e){let t=e.mark?`<img class="contact-mark" src="${F(e.mark)}" alt="" width="14" height="14" decoding="async" />`:``;return`<a class="contact-link" href="${F(e.href)}">${t}<span>${F(e.label)}</span></a>`}function H(){return`<div class="contact">
        ...
        </svg>`}function J(){let e=s.map(L).join(`
          `);return`<div class="page" id="holder">
      <div class="stage">
      <main class="him">
        <div class="bio">
          <header>
            <h1>${F(i)}<span class="scope" aria-hidden="true"></span></h1>
          </header>
          ${e}
        </div>
        ${H()}
    ...
    </div>`}function Y(e,t=!1){let n=t?`true`:`false`;return`<button type="button" class="${t?`row is-on`:`row`}" role="listitem" data-seat="${F(e.id)}" data-name="${F(e.name)}" data-blurb="${F(e.blurb)}" aria-pressed="${n}" aria-label="${F(e.name)}">${R(e.face,40,`row-face`)}<span class="row-id"><span class="row-name">${F(e.name)}</span><span class="row-blurb">${F(e.blurb)}</span></span></button>`}function X(){return`<main class="board" data-cycle="3000">
        <div class="roster" role="list">${g.map((e,t)=>Y(e,t===0)).join(``)}</div>
      </main>`}function Z(){return`<div class="page profile" id="holder">
      <div class="stage">
      <header class="mast">
        <h1>${F(f)}<span class="scope" aria-hidden="true"></span></h1>
      </header>
      ${X()}
      <footer class="foot">
        ${G(E.label,E.tip)}
        ${B()}
          ...
          </svg>`}function ee(){return`<svg class="thread-fig" viewBox="0 0 140 108" width="140" height="108" focusable="false" aria-hidden="true">
            <rect x="4.5" y="4.5" width="131" height="99" fill="none" stroke="rgba(250,250,247,0.12)" stroke-width="0.7"/>
          ...
          </svg>`}function te(e){return e===`protocol`?Q():e===`axes`?$():ee()}function ne(e){let t=e.href?`<p class="thread-link"><a href="${F(e.href)}">${F(e.linkLabel??`code`)}</a></p>`:``;return`<article class="thread" data-thread="${F(e.id)}">
          ${te(e.figure)}
          <div class="thread-copy">
            <h2>${F(e.title)}</h2>
            <p class="status">${F(e.status)}</p>
            <p>${F(e.abstract)}</p>
            ${t}
          </div>
        </article>`}function re(){return`<main class="threads">${C.map(ne).join(``)}</main>`}function ie(){return`<div class="page research" id="holder">
      <div class="stage">
      <header class="mast">
        <h1>${F(v)}<span class="scope" aria-hidden="true"></span></h1>
        <p class="cue">${F(x)}</p>
      </header>
      ${re()}
      <footer class="foot">
    ...
    </div>`}function ae(e){document.title=e.title;let t=[[`meta[name="description"]`,e.description],[`meta[property="og:title"]`,e.title],[`meta[property="og:description"]`,e.description],[`meta[property="og:url"]`,e.url],[`meta[name="twitter:title"]`,e.title],[`meta[name="twitter:description"]`,e.description]];for(let[e,n]of t)document.querySelector(e)?.setAttribute(`content`,n);document.querySelector(`link[rel="canonical"]`)?.setAttribute(`href`,e.url)}function oe(){let e=O(location.pathname),t=k(location.pathname),n=document.getElementById(`holder`);if(!n)return;let r=n.classList.contains(`profile`),i=n.classList.contains(`research`),a=!!n.querySelector(`.sky`);e&&!r?n.outerHTML=Z():t&&!i?n.outerHTML=ie():!e&&!t&&!a&&(n.outerHTML=J()),ae(e?N:t?P:M)}oe(),r(),j(),window.addEventListener(`resize`,j),window.visualViewport?.addEventListener(`resize`,j);